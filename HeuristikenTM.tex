...
\subsection{Resource Sharing und \TM}
Der folgende Algorithmus wurde angelehnt an \textcolor{red}{??} entwickelt.\\
...
Seien $(\omega _P)_{P \in \mathcal{P}_G}$ Preise für die Pfad-Ressourcen von $G$.

\textcolor{red}{damit das so weiter klappt muss ich möglchst schnell von den Kantengewichten wieder auf die pfad gewichte kommen!! dann im ein schritt verfahren die gew get nicht für jeden pfad muss entweder auf dem neuen graphen die gesamt verbrauche herausfinden oder das einschrittige zeiug vereinfachen}
\subsubsection{Ressourcenproblem}
\textcolor{red}{hier der teilweise überflüssige Subcuruits grund}

\textcolor{red}{doppeltes umformen: erst die kanten gewichte auf den neuen Graphen transformieren mit den neuen Ressource usages erneuern und aktualisierung vom held nutzen und wieder zurpck formen!}
\subsubsection{Rounding}

\subsubsection{sonstiges? zusammenfassung}
\textcolor{red}{binäre suche über B und kein FPTAS}
