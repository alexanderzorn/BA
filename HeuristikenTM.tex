...
Die Knoten eines Circuits sind durch Kanten miteinander verbunden. Diese müssen auf dem Chip in einer Menge von Schichten(Layer) liegen. Hierbei besitzt jede Schicht spezifische Eigenschaften an Geschwindigkeit und anderweitigen Kosten. \\
Während jedes \TM Algorithmus kommen neue Kanten hinzu oder verschwinden in dem äquivalenten Circuit. Das zu lösende Optimierungsproblem ist es nun den neu hinzugekommenden Kanten Layer zuzuordnen. In den Implementierungen der Algorithmen dieser Arbeit, werden die Kanten auf die Layer gelegt, auf welchen Sie vorher lagen. \\ Es steht noch aus zu prüfen ob und wie dieses Verfahren verbessert werden kann. Da dies bisher die beste Methode diese Problem zu lösen und in den getesteten Instanzen die zusätzlichen Kosten durch die Zuteilung der Kanten nicht übermäßig hoch sind, werden weder diese Kosten noch das Layer Assignment eine weitere Erwähnung in dieser Arbeit finden.
